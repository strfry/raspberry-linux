...
static int nau8822_set_dai_bclk_ratio(struct snd_soc_dai *codec_dai,
				 unsigned int ratio)
{
	// TODO: Implement set bclksel
	dev_dbg(codec_dai->dev, "%s: ratio %u\n", __func__, ratio);
	return 0;
}
				 ...
				 enum snd_soc_bias_level level)
{
	...
	/* FIXME: codec->dapm isn't available anymore, why check old state? */
	...
	// FIXME: As above, is this necessary anymore?
...
static const struct snd_soc_dai_ops nau8822_dai_ops = {
	...
	.set_bclk_ratio = nau8822_set_dai_bclk_ratio,
};
...
static int nau8822_probe(struct snd_soc_codec *codec)
{
	...
	/* FIXME: Check why this was necessary?
				      ...
				      const struct i2c_device_id *id)
{
	...
	nau8822->regmap = regmap_init_i2c(i2c, &nau8822_regmap_config);
